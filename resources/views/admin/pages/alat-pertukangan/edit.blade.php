...
<main class="main-content" id="mainContent">
    <div class="container-main">
        ...
        <div class="header-section">
            ...
            <p class="header-subtitle">
                Update alat baru untuk mengorganisir produk Anda dengan lebih baik. alat yang terstruktur membantu pelanggan menemukan apa yang mereka cari dengan lebih mudah dan cepat.
            </p>
        </div>
        ...
        <div class="form-container">
            ...
            <div class="form-header">
                <h2><i class="fas fa-edit"></i> Form Edit Item Produk</h2>
            </div>

            <!-- Form Content -->
        <form id="itemForm"
      action="{{ route('admin.alat.proses.update', $tools->id) }}"
      method="POST"
    ...
    <div class="form-grid">
        ...
        <div class="form-group">
            ...
            <input type="hidden" name="code" value="{{ $tools->code }}">
        </div>
            ...
            <select name="kategori_id"
                ...
                @foreach ($kategoris as $kategori)
                    <option value="{{ $kategori->id }}"
                        {{ old('kategori_id', $tools->kategori_id) == $kategori->id ? 'selected' : '' }}>
                        {{ $kategori->name }}
                    </option>
                @endforeach
            </select>
      ...
      <input type="text"
       name="features"
       value="{{ old('features', implode(', ', $tools->features ?? [])) }}"
       class="form-input">
        ...
        <div class="form-group full-width">
            ...
            <textarea name="description"
                      rows="8"
                      class="form-textarea">{{ old('description', $tools->description) }}</textarea>
        </div>
