...
@section('konten-ds')
 <style>
        ...
        * {
        ...
        /* Form Container - Layout Besar Tetap */
        .form-container {
            background: var(--white);
            border-radius: var(--radius-xl);
            overflow: hidden;
...
.form-select:valid + .select-arrow + .selected-option-preview {
    opacity: 1;
}
  ...
  <div class="container-main">
        ...
        <div class="header-section">
            ...
            <p class="header-subtitle">
                Tambahkan user baru ke dalam sistem. Pastikan semua informasi diisi dengan benar untuk memudahkan pengelolaan dan hak akses user.
            </p>
        </div>
        ...
        <div class="form-container">
            ...
            <div class="form-header">
                <h2><i class="fas fa-user-edit"></i> Form Tambah User</h2>
            </div>
    ...
    <form id="userForm"
      method="POST"
      class="form-content"
      action="{{ route('admin.manajemenuser.proses') }}"
   ...
   <div class="helper-text">
        ...
        <div class="form-group  @error('level') has-error @enderror">
            ...
            <div class="input-group">
                <div class="custom-select-wrapper">
                    <select id="level"
                            name="level"
                            class="form-select @error('level') error @enderror"
                            required>
                        <option value="" {{ old('level') == '' ? 'selected' : '' }}>Pilih Level User</option>
        ...
        <!-- Nomor HP -->
        <div class="form-group  @error('nomor_hp') has-error @enderror">
            ...
            <div class="input-group">
                <input type="tel"
                       id="nomor_hp"
                       name="nomor_hp"
                       class="form-input has-icon @error('nomor_hp') error @enderror"
    ...
    <div class="form-actions">
        ...
        <button type="submit" id="submitBtn" class="btn btn-primary">
            ...
            <span id="submitText">Tambah User</span>
    ...
    <script>
  // Level select preview update
const levelSelect = document.getElementById('level');
const selectedLevelPreview = document.getElementById('selectedLevelPreview');
...
levelSelect.addEventListener('change', function() {
    ...
    // Update preview text
    selectedLevelPreview.textContent = text;

    // Update icon based on selection
    if (value === 'admin') {
        levelIcon.className = 'fas fa-crown';
        levelIcon.style.color = '#EF4444';
    } else if (value === 'petugas') {
        levelIcon.className = 'fas fa-user-tie';
        levelIcon.style.color = '#3B82F6';
    } else {
        levelIcon.className = 'fas fa-user';
        levelIcon.style.color = '#10B981';
    }

    // Add animation
    selectedLevelPreview.style.animation = 'none';
    setTimeout(() => {
        selectedLevelPreview.style.animation = 'bounceIn 0.3s ease';
    }, 10);
});
...
document.addEventListener('DOMContentLoaded', function() {
    // Trigger change event to set initial preview
