    ...
    <div class="container-main">
        ...
        <div class="header-section">
            ...
            <p class="header-subtitle">
                Update user. Pastikan semua informasi diisi dengan benar untuk memudahkan pengelolaan dan hak akses user.
            </p>
        </div>
        ...
        <div class="form-container">
            ...
            <div class="form-header">
                <h2><i class="fas fa-user-edit"></i> Form Edit User</h2>
            </div>

            <!-- Form Content -->
            <form method="POST" action="{{ route('admin.manajemenuser.proses.update', $data_user->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                            ...
                            <div class="input-group">
                                <div class="custom-select-wrapper">
                                    <select id="level"
                                        ...
                                        required>
                                        <option value="" {{ old('level', $data_user->level) == '' ? 'selected' : '' }}>Pilih Level User</option>
                                        <option value="admin" {{ old('level', $data_user->level) == 'admin' ? 'selected' : '' }}>Admin</option>
                                        <option value="petugas" {{ old('level', $data_user->level) == 'petugas' ? 'selected' : '' }}>Petugas</option>
                                        <option value="user" {{ old('level', $data_user->level) == 'user' ? 'selected' : '' }}>User</option>
                                    </select>
