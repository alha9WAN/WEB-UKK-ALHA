    ...
    <div class="container-main active-page" id="list-page">
        ...
        <i class="fas fa-edit"></i>
            ...
            <p class="header-subtitle">
                Update kategori baru untuk mengorganisir produk Anda dengan lebih baik. Kategori yang terstruktur membantu pelanggan menemukan apa yang mereka cari dengan lebih mudah dan cepat.
            </p>
        </div>
        ...
        <div class="form-container">
            ...
            <div class="form-header">
                <h2><i class="fas fa-edit"></i> Form Update Kategori</h2>
            </div>
            ...
            <form id="kategoriForm"
                method="POST"
                class="form-content"
  action="{{ route('admin.kategori.proses.update', $kategori->id) }}"
                  enctype="multipart/form-data">

                @csrf
                  @method('PUT') <!-- penting, karena route pakai PUT -->
                <div class="form-grid">
                    <!-- Nama Kategori -->
                    ...
                    <div class="form-group full-width @error('description') has-error @enderror">
                        ...
                        <div class="input-group">
                            <textarea
                                ...
                                rows="5">{{ old('description', $kategori->description) }}</textarea>
        ...
        <!-- END Image Preview -->
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" id="submitBtn" class="btn btn-primary">
                        ...
                        <span id="submitText">Update Kategori</span>
