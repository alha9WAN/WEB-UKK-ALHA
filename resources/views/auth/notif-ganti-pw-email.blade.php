...
<head>
    ...
    <title>Reset Password - SoundShare</title>
            ...
            <div class="verification-left">
                <div class="left-header">
                    <div class="logo-left">
                        ...
                        <span class="logo-text-left">SoundShare</span>
                    </div>
                    ...
                    <p class="left-description">Link reset password telah dikirim ke email Anda</p>
                </div>
            ...
            <div class="verification-right">
                <div class="right-header">
                    <a href="/" class="logo-right">
                        ...
                        <span class="logo-text-right">SoundShare</span>
                    </a>

                    <h1 class="verification-title">Reset Password Anda</h1>
                    <p class="verification-subtitle">Kami telah mengirim link reset password ke email Anda</p>
                </div>

                <div class="alert-success">
                    <i class="fas fa-check-circle"></i>
                    <div class="alert-success-content">
                        <div class="alert-success-title">Link Reset Password Terkirim!</div>
                        <p class="alert-success-description">Link reset password telah dikirim ke email Anda. Silakan cek inbox atau folder spam Anda.</p>
                    </div>
                </div>

                <div class="verification-message">
                    <p><strong>Penting:</strong> Link reset password akan kadaluarsa dalam 1 jam. Jika Anda tidak menerima email, periksa folder spam atau klik tombol "Kirim Ulang Link Reset" di bawah.</p>
                </div>
                ...
                <div class="verification-steps">
                    <div class="step" style="animation: stepIn 0.5s ease-out 0.1s both;">
                        ...
                        <div class="step-content">
                            ...
                            <p class="step-description">Buka inbox email yang terdaftar. Cari email dengan subjek "Reset Password SoundShare".</p>
                        </div>
                    </div>
                    ...
                    <div class="step" style="animation: stepIn 0.5s ease-out 0.2s both;">
                        ...
                        <div class="step-content">
                            <h3 class="step-title">Klik Link Reset</h3>
                            <p class="step-description">Klik link "Reset Password" yang terdapat di dalam email untuk membuat password baru.</p>
                        </div>
                    </div>
                    ...
                    <div class="step" style="animation: stepIn 0.5s ease-out 0.3s both;">
                        ...
                        <div class="step-content">
                            <h3 class="step-title">Buat Password Baru</h3>
                            <p class="step-description">Setelah mengklik link, Anda akan diarahkan ke halaman untuk membuat password baru yang aman.</p>
                        </div>
                    </div>
                </div>
