...
<head>
    ...
    <title>Login | GreenTools - Alat Pertukangan Premium</title>
...
{{-- end swlart validasi --}}
    ...
    <div class="login-container">
        ...
        <div class="login-side">
            ...
            <form id="loginForm" action="{{ route('proses-login') }}" method="POST">
                @csrf
                ...
                <div class="options-row">
                    ...
                    <a href="{{ route('email.request') }}" class="forgot-link">
                        Lupa kata sandi?
                ...
                <div class="register-section">
                    ...
                    <a href="{{ route('show-registrasi') }}" class="register-link">
                        Daftar Sekarang
                        <i class="fas fa-arrow-right"></i>
                    </a>
                </div>
